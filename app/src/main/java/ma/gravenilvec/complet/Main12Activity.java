...
public class Main12Activity extends Activity {
    ...
    counter ct = new counter(61000, 1000);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main12);
        Controle_activitee.getCa().setActivity12(this);
        /********/
        /*Intent ii=getIntent();
...
*/
        ...
        h = new Random().nextInt(300);
        sbs = adapter.getItem(h);
        kilemet = sbs;
    ...
    public void valider(View view) {
        ...
        if(i==c.length && counter1>0) {
            ...
            p.stop();
            //finish();
            Intent  i1= new Intent(Main12Activity.this, Main13Activity.class);
            startActivity(i1);
            counter1=-1;
        ...
        else
        {
            ...
            //finish();
            counter1=-1;
            Intent  i3= new Intent(Main12Activity.this, Main14Activity.class);
            startActivity(i3);
            Controle_activitee.getCa().terminerActivitees();
        }
    }
    ...
    public char ajouterChar() {
        char c = '\0';
        char[] tabChar = {'ي','ب', 'ؤ', 'ئ', 'ى', 'ص', 'ي', 'ط', 'ظ', 'ع', 'غ', 'ف', 'ي', 'ق', 'ك', 'ل','ي','ن','ا', 'ه', 'و', 'ي', 'ء', 'ا', 'أ', 'إ', 'آ', 'ة', 'ض','ي', 'ث', 'ا', 'ج',  'ح', 'خ', 'د', 'ذ', 'ز', 'ر', 'ت', 'ا'};
    ...
    public void onBackPressed(){
        ...
        finish();
        Controle_activitee.getCa().terminerActivitees();
        Intent i=new Intent(Main12Activity.this,Main2Activity.class);
        startActivity(i);
        super.onBackPressed();
    }
}