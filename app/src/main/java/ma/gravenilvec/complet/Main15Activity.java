...
public class Main15Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Controle_activitee.getCa().setActivity15(this);
    ...
    public void onBackPressed(){
        ...
        finish();
        Intent i=new Intent(Main15Activity.this,Main2Activity.class);
        startActivity(i);
        P2.stop();
        p.stop();
        super.onBackPressed();
    ...
    class counter extends CountDownTimer {
        ...
        public void onTick(long millisUntilFinished){
            ...
            if(counter1==0) {
                p.pause();
                Controle_activitee.getCa().terminerActivitees();
                Intent i = new Intent(Main15Activity.this, Main17Activity.class);
                startActivity(i);
    ...
    public void click_(Button id_button ) {
        ...
        while (j == 1) {
            ...
            if (br_1.getIndice_click() == 1 && br_3.getIndice_click() == 1 && c!='\0') {
               ...
               else if (counter1 > 0 && (L.getResultat().getValeur()<=nbalea10+2 && L.getResultat().getValeur()>=nbalea10-2) )  {
    ...
    public void setView(){
        setContentView(R.layout.bclick15);
        b_1 = findViewById(R.id.buton1);
        b_2 = findViewById(R.id.button2);
        b_3 = findViewById(R.id.button3);
        b_4 = findViewById(R.id.button4);
