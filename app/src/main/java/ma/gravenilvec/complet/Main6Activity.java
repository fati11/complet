...
public class Main6Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Controle_activitee.getCa().setActivity6(this);
        /********/
        /*Intent ii=getIntent();
...
*/
    ...
    public void valider(View view) {
        ...
        if(i==c.length && counter1>0) {
            ...
            p.stop();
            //finish();
            Intent  i1= new Intent(Main6Activity.this, Main7Activity.class);
            startActivity(i1);
            counter1=-1;
        ...
        else
        {
            ...
            //finish();
            counter1=-1;
            Intent  i3= new Intent(Main6Activity.this, Main8Activity.class);
            startActivity(i3);
            Controle_activitee.getCa().terminerActivitees();
        }
    }
